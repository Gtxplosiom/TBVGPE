...
{
    public class PS4ControllerViewModel : ViewModelBase, IControllerLayoutManagerInterface
    {
        // Child elements
        ...
        public PS4ControllerViewModel()
        {
            ...
            string configPath = Path.Combine(appFolder, "ps4_config.json");
        ...
        public void LoadDefault()
        {
            ...
            DirectionalButtons.X = 20;
            DirectionalButtons.Y = 220;
            LeftAnalogStick.X = 170;
            LeftAnalogStick.Y = 400;
