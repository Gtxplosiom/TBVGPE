...
{
    public partial class SwitchUtilityButtons : UserControl
    {
        ...
        {
            AttachTouchHandlers(MinusBtn, Xbox360Button.Back);
            AttachTouchHandlers(HomeBtn, Xbox360Button.Guide);
            AttachTouchHandlers(PlusBtn, Xbox360Button.Start);

            AttachMouseHandlers(MinusBtn, Xbox360Button.Back);
            AttachMouseHandlers(HomeBtn, Xbox360Button.Guide);
            AttachMouseHandlers(PlusBtn, Xbox360Button.Start);
        }
