...
{
    public partial class Xbox360ControllerLayout : UserControl, INotifyPropertyChanged
    {
        // properties values
        ...
        // constuctor
        public Xbox360ControllerLayout()
        {
            InitializeComponent();
        ...
        private void InitializeControllerLayout(object sender, EventArgs e)
        {
            ...
            AnalogStickButtonsY = XboxShoulderButtonsControl.Height;
            DirectionalButtonsX = 170;
            DirectionalButtonsY = 400;
            LeftAnalogStickX = 70;
            LeftAnalogStickY = 200;
            FaceButtonsX = LayoutCanvas.Width - XboxFaceButtonsControl.Width - 20;
            FaceButtonsY = 220;
            UtilityButtonsX = LayoutCanvas.Width - Xbox360UtilityButtonsControl.Width - 20;
            UtilityButtonsY = 470;
