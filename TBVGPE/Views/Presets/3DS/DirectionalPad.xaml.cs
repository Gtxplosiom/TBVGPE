    ...
    public partial class DirectionalPad : UserControl
    {
        ...
        private void Button_PreviewTouchUp(object sender, TouchEventArgs e)
        {
            if (sender is Button btn && btn.Tag is string tag)
            {
                ...
                btn.Background = IsDiagonal(tag) ? _defaultDiagonalButtonBackground : _defaultButtonBackground;
                e.Handled = true;
            }
        }
        ...
        private bool IsDiagonal(string tag)
        {
            return tag.Contains(",");
        }
    }
...
// TODO: himua ini na optimized pag hin jojoystick like, kun da-drag ngan move. palyado pa labi kun ho-hold
