...
{
    public class SwitchControllerViewModel : ViewModelBase, IControllerLayoutManagerInterface
    {
        // Child elements
        ...
        public SwitchControllerViewModel()
        {
            ...
            string configPath = Path.Combine(appFolder, "switch_config.json");
