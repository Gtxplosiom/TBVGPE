...
{
    public partial class DSControllerLayout : UserControl, INotifyPropertyChanged
    {
        // properties values
        ...
        private void InitializeControllerLayout(object sender, EventArgs e)
        {
            ...
            DirectionalButtonsY = 120;
            FaceButtonsX = LayoutCanvas.Width - NintendoNewFaceButtonsControl.Width - 50;
            FaceButtonsY = 120;
            UtilityButtonsX = LayoutCanvas.Width - DSUtilityButtonsControl.Width - 115;
            UtilityButtonsY = 350;
        }
    }
}
